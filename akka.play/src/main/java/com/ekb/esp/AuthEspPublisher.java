...
public class AuthEspPublisher extends UntypedActor {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message instanceof HashMap) {
            ...
            data.add(new dfESPdvTimeStamp(new Date((long)parts.get("syslogDate"))));
            data.add(new dfESPdvString((String)parts.get("serverName")));
            data.add(new dfESPdvTimeStamp(new Date((long)parts.get("loginDate"))));
            data.add(new dfESPdvString((String)parts.get("user")));
            data.add(new dfESPdvString((String)parts.get("ipAddress")));
